          ...
          <div className="overlay__image">
            <img
              ...
              srcSet={`${urlForImage(image.asset._id)
                .width(400)
                .url()} 400w, ${urlForImage(image.asset._id)
                .width(560)
                .url()} 560w, ${urlForImage(image.asset._id)
                .width(720)
                .url()} 720w, ${urlForImage(image.asset._id)
                .width(880)
                .url()} 880w, ${urlForImage(image.asset._id)
                .width(1080)
                .url()} 1080w, ${urlForImage(image.asset._id)
                .width(1280)
